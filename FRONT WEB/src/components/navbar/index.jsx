...
import navbarimage from "../../assets/image/layout/Navbar.png";
...
const Navbar = (props) => {
  ...
  const handleGoBack = () => {
    // Go back to the previous page, passing a "from" state to mark it as navigating back
    window.history.back({ state: { from: "back" } });
  };
  ...
  return (
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
      <div className="ml-[6px]">
        ...
        <p onClick={handleGoBack} className="shrink text-[16px] cursor-pointer capitalize text-navy-700 dark:text-white">
          ...
          children={
            <div className="flex h-36 w-56 flex-col justify-start rounded-[20px] bg-white bg-cover bg-no-repeat shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none">
              ...
              <div className=" flex gap-24 items-center justify-center p-2 ">
                <a
                  href="/admin/profile "
                  className="text-md font-medium text-dark hover:text-dark"
                >
                  Mon profile 
                </a><MdPerson className="h-6 w-6" />
                </div>
                <hr />
            <div className=" flex gap-20 items-center justify-center p-2 ">
            <button
              onClick={logOut}
