...
const Contact = () => {
  return (
   ...
   <Header/>
    <section class=" h-screen z-10 overflow-hidden   ">
        ...
        <div class="-mx-4 flex flex-wrap lg:justify-between">
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h2
                class="text-blue-500 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
              >
                Ajouter votre touche
              </h2>
              <p class="text-navy-700 dark:text-white mb-9 text-base leading-relaxed">
              ...
              <div class="mb-4 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-blue-500 mb-1 text-xl font-bold">Localisation</h4>
                  <p class="text-navy-700 dark:text-white text-base">
                    1994 S.t Bejaia. Algerie
                  </p>
                </div>
              </div>
              <div class="mb-4 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-blue-500 mb-1 text-xl font-bold">Mobile</h4>
                  <p class="text-navy-700 dark:text-white text-base">(+213)123 456 789</p>
                </div>
              </div>
              <div class="mb-4 flex w-full max-w-[370px]">
                <div
                  class="bg-black text-blue-200 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                >
                  <svg
                    width="28"
                    height="19"
                ...
                <div class="w-full">
                  <h4 class="text-blue-500 mb-1 text-xl font-bold">Adresse e-mail</h4>
                  <p class="text-navy-700 dark:text-white text-base">contact@goodswap.com</p>
                </div>
              </div>
            </div>
          </div>
          <div class="w-full h-32 px-4 lg:w-1/2 xl:w-5/12">
            <div class="relative rounded-lg  p-8 dark:shadow-gray-800  shadow border  sm:p-12">
              <form>
                <div class="mb-4">
                  <input
                    type="text"
                    placeholder="Nom et prénom"
                    class="text-body-color border-[f0f0f0] dark:border dark:border-gray-700 dark:!bg-navy-900 focus:border-primary w-full rounded-lg border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  />
                </div>
                <div class="mb-4">
                  <input
                ...
                <div class="mb-4">
                  <textarea
                    ...
                    class="text-body-color border-[f0f0f0]  dark:border dark:border-gray-700 dark:!bg-navy-900 focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  ></textarea>
                </div>
                <div>
                  <button
                    type="submit"
                    class="btn btn-outline tex w-full rounded-lg dark:text-white dark:bg-blue-600   border p-3  transition hover:bg-opacity-90"
                  >
