  ...
  return (
    <div className="sticky !z-50  lg:!z-50  bg-white shadow-sm rounded-[10px] p-4 pt-8 ">
      ...
      >
        ...
        <span className={`pl-3 text-[14px]  ${active === 1 ? "text-[blue]" : ""}  `}>
          Profile
        </span>
      </div>
      <div
      ...
      >
        ...
        <span className={`pl-3 text-[14px] ${active === 2 ? "text-[blue]" : ""}  `}>
          Mes dons
        </span>
      </div>
      <div
      ...
      >
        ...
        <span className={`pl-3 text-[14px] ${active === 3 ? "text-[blue]" : ""}   `}>
          Mes Adoptions
        </span>
      </div>
      ...
      >
        ...
        <span className={`pl-3 text-[14px]  ${active === 4 ? "text-[blue]" : ""} 800px:block `}>
        D.adoptions 
        </span>
      </div>
