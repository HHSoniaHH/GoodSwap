...
const GeneralInfoOrgan = ({NomOrganisation,adresse,TelOrganisation,Dirigeant,EmailOrganisation}) => {
                ...
                >
                 <div className="grid grid-cols-1 gap-3 md:grid-cols-2 mb-4 ">
                  ...
                  <div className="mb-4">
                    ...
                    //    value={userData.email||profile.email} onChange={handleChange}
...
export default GeneralInfoOrgan