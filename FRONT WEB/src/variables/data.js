...
export const navProfile = [
  { name: 'Accueil', href: '/user/userHome' },
  { name: 'Contactez-nous ', href: '/' },
  { name: 'Messages ', href: '/user/Message' },
 
];
export const hero = {
  title: 'Troquez pour faire des économies',
  subtitle: 'Helps you to organize your income and expenses',
  btnText: 'Etre impliqué',
  compText: ' Web, Android',
  image: HeroImg,
};
...
export const copyright = {
  ...
  copyText: 'Copyright @ 2023 GOOD SWAP',
  social: [
